...
ggsave("weekly_avg_poll.jpg",plot = weekly_avg_poll, width = 9,height = 4, path = here::here("plotted images"))
# print saved plots
knitr::include_graphics(here::here("plotted images", "weekly_avg_poll.jpg"))
