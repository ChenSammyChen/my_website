...
ggsave("white_firearm_plot.jpg",plot = white_firearm_plot, width = 9, height = 7, path = here::here("static/img/blogs"))
knitr::include_graphics(here::here("static/img/blogs", "white_firearm_plot.jpg"))
